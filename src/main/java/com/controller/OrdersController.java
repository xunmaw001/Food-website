...
public class OrdersController {
    ...
    public R page(@RequestParam Map<String, Object> params,OrdersEntity orders,
		...
		if(tableName.equals("canting")) {
			orders.setCantingzhanghao((String)request.getSession().getAttribute("username"));
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("canting")) {
			wrapper.eq("cantingzhanghao", (String)request.getSession().getAttribute("username"));
		}
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("canting")) {
            ew.eq("cantingzhanghao", (String)request.getSession().getAttribute("username"));
		}
