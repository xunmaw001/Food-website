...
public class CantingController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		CantingEntity u = cantingService.selectOne(new EntityWrapper<CantingEntity>().eq("cantingzhanghao", username));
		if(u==null || !u.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		
		String token = tokenService.generateToken(u.getId(), username,"canting",  "餐厅" );
    ...
    public R register(@RequestBody CantingEntity canting){
    	...
    	CantingEntity u = cantingService.selectOne(new EntityWrapper<CantingEntity>().eq("cantingzhanghao", canting.getCantingzhanghao()));
		if(u!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        CantingEntity u = cantingService.selectById(id);
