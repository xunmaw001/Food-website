	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20220804/7b6725db49ff41fcbf4d90334e06cd1c.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"30px","boxShadow":"20px 20px 0px 20px rgba(0,0,0,0.3020)","margin":"0","borderRadius":"0","background":"#fff","width":"430px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"margin":"0 0 20px 0","color":"rgba(0, 0, 0, 1)","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"22px","height":"auto"}' class="title">一款基于BS的美食网站的设计与实现注册</div>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='canting'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">餐厅账号</div>
					<el-input  v-model="ruleForm.cantingzhanghao"  autocomplete="off" placeholder="餐厅账号"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='canting'">
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='canting'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">餐厅名称</div>
					<el-input  v-model="ruleForm.cantingmingcheng"  autocomplete="off" placeholder="餐厅名称"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='canting'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">餐厅位置</div>
					<el-input  v-model="ruleForm.cantingweizhi"  autocomplete="off" placeholder="餐厅位置"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='canting'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">餐厅电话</div>
					<el-input  v-model="ruleForm.cantingdianhua"  autocomplete="off" placeholder="餐厅电话"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='canting'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">餐厅封面</div>
                    <file-upload
                        tip="点击上传餐厅封面"
                        action="file/upload"
                        :limit="3"
	...
	methods: {
		...
		login() {
			var url=this.tableName+"/register";
					if((!this.ruleForm.cantingzhanghao) && `canting` == this.tableName){
						this.$message.error(`餐厅账号不能为空`);
						return
					}
					...
					if((!this.ruleForm.cantingmingcheng) && `canting` == this.tableName){
					...
					if(`canting` == this.tableName && this.ruleForm.cantingdianhua&&(!this.$validate.isMobile(this.ruleForm.cantingdianhua))){
						this.$message.error(`餐厅电话应输入手机格式`);
						return
					}
            ...
            if(this.ruleForm.cantingfengmian!=null) {
                this.ruleForm.cantingfengmian = this.ruleForm.cantingfengmian.replace(new RegExp(this.$base.url,"g"),"");
					...
					if(`canting` == this.tableName && this.ruleForm.money&&(!this.$validate.isNumber(this.ruleForm.money))){
