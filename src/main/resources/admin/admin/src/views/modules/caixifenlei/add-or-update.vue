<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="菜系分类" prop="caixifenlei">
					<el-input v-model="ruleForm.caixifenlei" placeholder="菜系分类" clearable  :readonly="ro.caixifenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="菜系分类" prop="caixifenlei">
					<el-input v-model="ruleForm.caixifenlei" placeholder="菜系分类" readonly></el-input>
				</el-form-item>
			</template>
