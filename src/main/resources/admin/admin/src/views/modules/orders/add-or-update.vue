	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="商户名称" prop="cantingzhanghao">
					<el-input v-model="ruleForm.cantingzhanghao" placeholder="商户名称" clearable  :readonly="ro.cantingzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="商户名称" prop="cantingzhanghao">
					<el-input v-model="ruleForm.cantingzhanghao" placeholder="商户名称" readonly></el-input>
				</el-form-item>
...
export default {
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../springboot0fh04/upload');
        } else {
