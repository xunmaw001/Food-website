...
<div :style='{"border":"2px solid #dbd9f4","padding":"20px","margin":"10px auto","borderRadius":"8px","background":"#fff","width":"1200px","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="餐厅位置" prop="cantingweizhi">
            <el-input v-model="ruleForm.cantingweizhi" 
                placeholder="餐厅位置" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="餐厅电话" prop="cantingdianhua">
            <el-input v-model="ruleForm.cantingdianhua" 
                placeholder="餐厅电话" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="餐厅封面" prop="cantingfengmian">
            <file-upload
            tip="点击上传餐厅封面"
            action="file/upload"
            :limit="3"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="餐厅详情" prop="cantingxiangqing">
            <editor 
  ...
  export default {
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='cantingfengmian'){
              this.ruleForm.cantingfengmian = obj[o].split(",")[0];
              continue;
            }
        ...
        this.$http.get(this.userTableName + '/session', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            ...
            if(json.cantingweizhi!=''&&json.cantingweizhi){
                this.ruleForm.cantingweizhi = json.cantingweizhi
            }
            if(json.cantingdianhua!=''&&json.cantingdianhua){
    ...
    // 多级联动参数
      ...
      cantingfengmianUploadChange(fileUrls) {
          this.ruleForm.cantingfengmian = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");;
      },
    }
  };
</script>
