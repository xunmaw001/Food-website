    ...
    <el-tabs tab-position="left" :style='{"border":"2px solid #dbd9f4","padding":"20px","margin":"8px 4px 4px 4px","borderRadius":"16px","background":"#fff"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='canting'" label="餐厅账号" prop="cantingzhanghao">
            <el-input v-model="sessionForm.cantingzhanghao" placeholder="餐厅账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='canting'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='canting'" label="餐厅名称" prop="cantingmingcheng">
            <el-input v-model="sessionForm.cantingmingcheng" placeholder="餐厅名称" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='canting'" label="餐厅位置" prop="cantingweizhi">
            <el-input v-model="sessionForm.cantingweizhi" placeholder="餐厅位置" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='canting'" label="餐厅电话" prop="cantingdianhua">
            <el-input v-model="sessionForm.cantingdianhua" placeholder="餐厅电话" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='canting'" label="餐厅封面">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="cantingcantingfengmianHandleAvatarSuccess">
              <img :style='{"border":"1px solid #dbd9f4","cursor":"pointer","color":"#b3aeea","borderRadius":"30px","textAlign":"center","width":"200px","fontSize":"32px","lineHeight":"120px"}' v-if="sessionForm.cantingfengmian" :src="baseUrl + sessionForm.cantingfengmian" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
          <el-form-item class="balance" :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='canting'" label="余额">
          ...
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='yonghu'" label="用户电话" prop="yonghudianhua">
...
<script>
  ...
  export default {
    ...
    created() {
      if ('canting' == this.userTableName) {
        this.$set(this.sessionForm, 'cantingzhanghao', null);
      }
      if ('canting' == this.userTableName) {
        this.$set(this.sessionForm, 'mima', null);
      }
      if ('canting' == this.userTableName) {
        this.$set(this.sessionForm, 'cantingmingcheng', null);
      }
      if ('canting' == this.userTableName) {
        this.$set(this.sessionForm, 'cantingweizhi', null);
      }
      if ('canting' == this.userTableName) {
        this.$set(this.sessionForm, 'cantingdianhua', null);
      }
      if ('canting' == this.userTableName) {
        this.$set(this.sessionForm, 'cantingfengmian', null);
      }
      if ('canting' == this.userTableName) {
      ...
      if ('canting' == this.userTableName) {
        this.$set(this.rules, 'cantingzhanghao', [{ required: true, message: '请输入餐厅账号', trigger: 'blur' }]);
      }
      if ('canting' == this.userTableName) {
        this.$set(this.rules, 'mima', [{ required: true, message: '请输入密码', trigger: 'blur' }]);
      }
      if ('canting' == this.userTableName) {
        this.$set(this.rules, 'cantingmingcheng', [{ required: true, message: '请输入餐厅名称', trigger: 'blur' }]);
      }
			if ('canting' == this.userTableName) {
        this.$set(this.rules, 'cantingdianhua', [{ required: false, validator: this.$validate.isMobile, trigger: 'blur' }]);
      }
			if ('canting' == this.userTableName) {
    ...
    methods: {
      ...
      cantingcantingfengmianHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('canting' == this.userTableName) {
            this.sessionForm.cantingfengmian = 'upload/' + res.file;
          }
        }
      },
